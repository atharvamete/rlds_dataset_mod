...
DOWNLOAD_DIR=/home/amete7/scratch/openx_data
CONVERSION_DIR=/home/amete7/scratch/openx_temp
N_WORKERS=15                  # number of workers used for parallel conversion --> adjust based on available RAM
MAX_EPISODES_IN_MEMORY=450    # number of episodes converted in parallel --> adjust based on available RAM
